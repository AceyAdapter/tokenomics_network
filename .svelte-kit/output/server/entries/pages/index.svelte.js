...
var daisyui = "/_app/assets/daisyui-6812931f.jpeg";
var sveltekit = "/_app/assets/sveltekit-dd5d3dc4.png";
const Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div><div class="${"text-2xl text-center p-10"}">Web App Boilerplate</div>
    <div class="${"flex flex-row w-full justify-center"}"><img${add_attribute("src", daisyui, 0)} alt="${"DaisyUI"}" class="${"rounded-xl w-96 shadow-xl"}">
        ...
        <img${add_attribute("src", sveltekit, 0)} alt="${"SvelteKit"}" class="${"rounded-xl w-96 shadow-xl"}"></div></div>`;
});
